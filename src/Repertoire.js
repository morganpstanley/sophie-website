  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><span className="song">Stand</span><span className="composer">Me</span><span className="composer">Ben E. King</span></li>
        ...
        <li>Plus renaissance, baroque, and folk tunes</li>
      </ul>
    </>
  );
};
